  ...
  return (
    <Container padding="px-0 py-0 ">
      <div className="w-full grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-8 ">
        ...
        {/* Col 2  */}
        <div className="w-full lg:min-h-screen flex items-center justify-start flex-col bg-balticSea rounded-tl-[24px] xs:rounded-tl-[30px] sm:rounded-tl-[70px] px-6 sm:px-9 lg:px-12 py-7 md:py-9 lg:py-12 relative">
